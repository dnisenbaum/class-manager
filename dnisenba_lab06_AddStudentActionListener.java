...
public class dnisenba_lab06_AddStudentActionListener implements ActionListener {
	...
	public void actionPerformed(ActionEvent event){
		...
		while (courseNotFound == true){
			tempName = JOptionPane.showInputDialog(null,"Enter Course to add Student to: ",
